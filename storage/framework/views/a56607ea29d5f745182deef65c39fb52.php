...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <?php $sched = $bid->schedule; $ac = $bid->aircraft; ?>
        <div class="card-hover p-5 flex items-center justify-between">
            <div class="flex items-center gap-6">
                <div class="text-center min-w-[70px]">
                    <p class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e(optional($sched)->departure ?? 'N/A'); ?></p>
                    <p class="text-xs text-slate-500"><?php echo e(optional($sched)->departure_time ?? '--'); ?></p>
                </div>
                <div class="flex flex-col items-center gap-1">
                    <span class="text-xs font-medium text-slate-400"><?php echo e(optional($sched)->flight_number ?? 'Deleted'); ?></span>
                    ...
                    <span class="text-xs text-slate-400"><?php echo e(optional($sched)->flight_time ?? '-'); ?>h</span>
                </div>
                <div class="text-center min-w-[70px]">
                    <p class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e(optional($sched)->arrival ?? 'N/A'); ?></p>
                    <p class="text-xs text-slate-500">---</p>
                </div>
                <div class="text-sm text-slate-500">
                    <span class="badge-info"><?php echo e(optional($ac)->registration ?? 'N/A'); ?></span>
                    <p class="text-xs mt-1">Aircraft: <?php echo e(optional($ac)->icao ?? '-'); ?></p>
                </div>
            </div>
            <button wire:click="cancel(<?php echo e($bid->id); ?>)" wire:confirm="Cancel this booking?" wire:loading.attr="disabled" class="btn-secondary text-red-600 dark:text-red-400 border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 flex items-center gap-2">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        <div class="card p-12 text-center">
            ...
            <a href="<?php echo e(route('flights')); ?>" wire:navigate class="btn-primary inline-flex mt-4">Browse Flights</a>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\Users\noxxr\Desktop\FlyAway-VAM\resources\views\livewire/my-bookings.blade.php ENDPATH**/ ?>