...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            <div class="flex flex-col gap-2">
                ...
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="<?php echo e(route('register')); ?>" wire:navigate>
...
</div><?php /**PATH C:\Users\noxxr\Desktop\FlyAway-VAM\resources\views\livewire/pages/auth/login.blade.php ENDPATH**/ ?>