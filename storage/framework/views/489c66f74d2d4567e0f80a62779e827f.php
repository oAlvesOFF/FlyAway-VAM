...
<div class="pf-wrap">
    ...
    <div class="pf-stats-grid">
        <div class="pf-stat-card">
            ...
            <div class="pf-stat-val"><i class="ph-fill ph-identification-badge" style="color: var(--text-badge); font-size: 20px;"></i> <?php echo e($user->pilot_id); ?></div>
        </div>
        <div class="pf-stat-card">
            <div class="pf-stat-lbl">Rank</div>
            <div class="pf-stat-val"><i class="ph-fill ph-medal" style="color: #f59e0b; font-size: 20px;"></i> <?php echo e($user->rank?->name ?? 'Candidate'); ?></div>
        </div>
        <div class="pf-stat-card">
            <div class="pf-stat-lbl">Total Hours</div>
            <div class="pf-stat-val"><i class="ph-fill ph-clock" style="color: var(--text-badge); font-size: 20px;"></i> <?php echo e(number_format($user->total_hours, 1)); ?></div>
        </div>
        <div class="pf-stat-card">
            <div class="pf-stat-lbl">Flights</div>
            <div class="pf-stat-val"><i class="ph-fill ph-airplane-tilt" style="color: var(--text-badge); font-size: 20px;"></i> <?php echo e($user->total_flights); ?></div>
        </div>
        <div class="pf-stat-card">
            <div class="pf-stat-lbl">Status</div>
            <div class="pf-stat-val <?php echo e($user->status === 'active' ? 'green' : ''); ?>">
                <i class="ph-fill <?php echo e($user->status === 'active' ? 'ph-check-circle' : 'ph-warning-circle'); ?>" style="font-size: 20px;"></i>
        ...
        <div class="pf-stat-card">
            ...
            <div class="pf-stat-val" style="font-family: monospace;">
                <i class="ph-fill ph-map-pin" style="color: #ef4444; font-size: 20px;"></i> <?php echo e($user->last_location ?? '---'); ?>
        ...
        <div class="pf-stat-card">
            ...
            <div class="pf-stat-val" style="font-size: 15px;">
                <i class="ph-fill ph-paper-plane-tilt" style="color: var(--text-badge); font-size: 18px;"></i> <?php echo e($user->simbrief_username ?? 'Not set'); ?>
        ...
        <div class="pf-stat-card">
            ...
            <div class="pf-stat-val" style="font-size: 15px;">
                <i class="ph-fill ph-calendar" style="color: var(--text-muted); font-size: 18px;"></i> <?php echo e($user->created_at->format('M Y')); ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1871839168-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1871839168-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1871839168-2', $__key);
...
<?php echo $__env->make('layouts.app', ['title' => 'Profile'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\noxxr\Desktop\FlyAway-VAM\resources\views/profile.blade.php ENDPATH**/ ?>