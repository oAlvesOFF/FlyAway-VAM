<?php $chartPireps = auth()->user()->pireps()->latest()->limit(10)->get(['status', 'score', 'flight_number', 'created_at']); ?>
...
<div class="db-wrap">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->status === 'suspended'): ?>
        <div style="background: rgba(239,68,68,0.1); border: 1px solid rgba(239,68,68,0.25); border-radius: 10px; padding: 18px 20px; margin-bottom: 24px; display: flex; gap: 12px; align-items: flex-start;">
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->suspension_reason): ?>
                    <div style="font-size: 13px; color: #ef4444; opacity: 0.85;"><?php echo e(auth()->user()->suspension_reason); ?></div>
    ...
    <div class="db-banner">
        <div class="db-banner-left">
            ...
            <div class="db-banner-name"><?php echo e(auth()->user()->name); ?></div>
            <div class="db-banner-sub">
                <i class="ph-fill ph-medal" style="margin-right:4px;"></i><?php echo e(auth()->user()->rank?->name ?? 'Candidate'); ?>

                &nbsp;&bull;&nbsp;
                <i class="ph-fill ph-map-pin" style="margin-right:4px;"></i><?php echo e(auth()->user()->last_location ?? 'No location'); ?>

                &nbsp;&bull;&nbsp;
                <i class="ph-fill ph-identification-card" style="margin-right:4px;"></i><?php echo e(auth()->user()->pilot_id ?? 'N/A'); ?>

            </div>
        </div>
        <div class="db-banner-right">
            <div class="db-banner-badge">
                <div class="db-banner-badge-val"><?php echo e(number_format(auth()->user()->total_hours, 1)); ?></div>
                <div class="db-banner-badge-lbl">Total Hours</div>
            </div>
            <div class="db-banner-badge">
                <div class="db-banner-badge-val"><?php echo e(auth()->user()->total_flights); ?></div>
            ...
            ?>
            <div class="db-banner-badge">
                <div class="db-banner-badge-val"><?php echo e($approvedCount); ?></div>
                <div class="db-banner-badge-lbl">Approved</div>
            </div>
            <div class="db-banner-badge">
                <div class="db-banner-badge-val"><?php echo e($avgScore ? number_format($avgScore, 0) : '—'); ?></div>
    ...
    <div class="db-stats">
        <div class="db-stat">
            ...
            <div>
                <div class="db-stat-val"><?php echo e(number_format(auth()->user()->total_hours, 1)); ?>h</div>
        ...
        <div class="db-stat">
            ...
            <div>
                <div class="db-stat-val"><?php echo e(auth()->user()->total_flights); ?></div>
        ...
        <div class="db-stat">
            ...
            <div>
                <div class="db-stat-val" style="font-size: 15px;"><?php echo e(auth()->user()->rank?->name ?? 'Candidate'); ?></div>
        ...
        <div class="db-stat">
            ...
            <div>
                <div class="db-stat-val" style="font-family: monospace;"><?php echo e(auth()->user()->last_location ?? '—'); ?></div>
    ...
    <div class="db-main-grid">
        ...
        <div class="db-card">
            ...
            <div class="db-card-body">
                <?php $nextBid = auth()->user()->bids()->with('schedule')->latest()->first(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextBid && $nextBid->schedule): ?>
                    <div class="db-route-wrap">
                        <div style="text-align: center;">
                            <div class="db-icao"><?php echo e($nextBid->schedule->departure); ?></div>
                            <div class="db-city"><?php echo e($nextBid->schedule->departure); ?></div>
                        </div>
                        <div class="db-path-mid">
                            <div class="db-path-num"><?php echo e($nextBid->schedule->flight_number); ?></div>
                            <div class="db-path-line-wrap">
                                <div class="db-path-line"></div>
                                <div class="db-path-plane"><i class="ph-fill ph-airplane-in-flight"></i></div>
                                <div class="db-path-line"></div>
                            </div>
                            <div class="db-path-time"><?php echo e($nextBid->schedule->flight_time); ?>h</div>
                        </div>
                        <div style="text-align: center;">
                            <div class="db-icao"><?php echo e($nextBid->schedule->arrival); ?></div>
                            <div class="db-city"><?php echo e($nextBid->schedule->arrival); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="db-flight-info">
                        <div class="db-info-chip">
                            ...
                            <div class="db-info-chip-val"><?php echo e($nextBid->schedule->flight_number); ?></div>
                        </div>
                        <div class="db-info-chip">
                            <div class="db-info-chip-lbl">Duration</div>
                            <div class="db-info-chip-val"><?php echo e($nextBid->schedule->flight_time); ?>h</div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextBid->schedule->aircraft_type): ?>
                        <div class="db-info-chip">
                            <div class="db-info-chip-lbl">Aircraft</div>
                            <div class="db-info-chip-val"><?php echo e($nextBid->schedule->aircraft_type); ?></div>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>

                    <a href="<?php echo e(route('simbrief')); ?>" wire:navigate class="db-action-btn">
                ...
                <?php else: ?>
                    <div class="db-empty">
                        ...
                        <a href="<?php echo e(route('flights')); ?>" wire:navigate class="db-action-btn">
        ...
        <div class="db-card">
            <div class="db-card-header">
                ...
                <a href="<?php echo e(route('my-pireps')); ?>" wire:navigate class="db-card-link">View all →</a>
            </div>
            <div class="db-card-body">
                <?php $recentPireps = auth()->user()->pireps()->latest()->take(5)->get(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentPireps->count() > 0): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentPireps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pirep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="db-pirep-row" onclick="window.location.href='<?php echo e(route('my-pireps')); ?>'">
                            <div>
                                <div class="db-pirep-fn"><?php echo e($pirep->flight_number); ?></div>
                                <div class="db-pirep-route"><?php echo e($pirep->departure); ?> &rarr; <?php echo e($pirep->arrival); ?> &bull; <?php echo e($pirep->created_at->diffForHumans()); ?></div>
                            </div>
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <div class="db-pirep-time"><?php echo e($pirep->flight_time); ?>h</div>
                                <span class="db-badge <?php echo e($pirep->status); ?>"><?php echo e(ucfirst($pirep->status)); ?></span>
                            </div>
                        </div>
                ...
                <?php else: ?>
                    <div class="db-empty">
                        ...
                        <a href="<?php echo e(route('file-pirep')); ?>" wire:navigate class="db-action-btn">File a PIREP</a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    ...
    <div class="db-card" style="margin-bottom: 20px;">
        <div class="db-card-header">
            ...
            <span style="font-size: 12px; font-weight: 600; color: var(--text-muted);"><?php echo e(number_format($progress, 1)); ?>% complete</span>
        </div>
        <div class="db-card-body">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextRank): ?>
                <div class="db-prog-wrap">
                    <div class="db-prog-labels">
                        <span class="db-prog-cur"><i class="ph-fill ph-medal" style="margin-right: 4px;"></i><?php echo e(auth()->user()->rank?->name ?? 'Candidate'); ?></span>
                        <span class="db-prog-next"><?php echo e($nextRank->name); ?> <i class="ph-fill ph-arrow-right" style="margin-left: 2px;"></i></span>
                    </div>
                    <div class="db-prog-bar">
                        <div class="db-prog-fill" style="width: <?php echo e($progress); ?>%;"></div>
                    </div>
                    <div class="db-prog-footer">
                        <span class="db-prog-hint">
                            <i class="ph-fill ph-clock" style="margin-right: 4px;"></i>
                            <?php echo e($hoursToNext); ?> hours to next rank
                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextRank->allowed_categories): ?>
                            <?php $unlocks = array_diff(explode(',', $nextRank->allowed_categories), explode(',', auth()->user()->rank?->allowed_categories ?? '')); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($unlocks) > 0): ?>
                                <span class="db-prog-unlock">Unlocks: <?php echo e(implode(', ', $unlocks)); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <?php $allRanks = \App\Models\Rank::orderBy('minimum_hours')->get(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allRanks->count() > 0): ?>
                <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allRanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php $reached = $currentHours >= $r->minimum_hours; ?>
                        <div style="flex: 1; min-width: 80px; text-align: center; padding: 10px 8px; border-radius: 8px; border: 1px solid var(--border-card); background: <?php echo e($reached ? 'rgba(81,140,229,0.1)' : 'var(--bg-header)'); ?>;">
                            <div style="font-size: 18px; color: <?php echo e($reached ? 'var(--text-badge)' : 'var(--text-muted)'); ?>;">
                                <i class="ph-fill <?php echo e($reached ? 'ph-medal' : 'ph-lock'); ?>"></i>
                            </div>
                            <div style="font-size: 11px; font-weight: 700; color: <?php echo e($reached ? 'var(--text-primary)' : 'var(--text-muted)'); ?>; margin-top: 4px;"><?php echo e($r->name); ?></div>
                            <div style="font-size: 10px; color: var(--text-muted);"><?php echo e($r->minimum_hours); ?>h</div>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function () {
    const pireps = <?php echo json_encode($chartPireps, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', ['title' => 'Dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\noxxr\Desktop\FlyAway-VAM\resources\views/dashboard.blade.php ENDPATH**/ ?>